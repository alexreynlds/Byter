...
public class HealthBarScript : MonoBehaviour
{
    ...
    void CreateHealthBar()
    {
        ...
        startHealth.GetComponent<RectTransform>().anchoredPosition = new Vector3(0, 0, 0);
        ...
        for (int i = 0; i < middleHealthCount / 2; i++)
        {
            ...
            middleHealth.GetComponent<RectTransform>().anchoredPosition = new Vector3(healthSprites[healthSprites.Count - 1].GetComponent<RectTransform>().anchoredPosition.x + 30, 0, 0);
        ...
        endHealth.GetComponent<RectTransform>().anchoredPosition = new Vector3(healthSprites[healthSprites.Count - 1].GetComponent<RectTransform>().anchoredPosition.x + 30, 0, 0);
